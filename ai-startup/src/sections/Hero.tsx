...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Purple Circle centered absolutely */}
      ...
      {/* {start ring 2} */}
      <div className="absolute h-[444px] w-[444px] md:h-[780px] md:w-[780px] border border-white/20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0"></div>
      {/* {end ring 2} */}

      {/* {start ring 3} */}
      <div className="absolute h-[544px] w-[544px] md:h-[980px] md:w-[980px] border border-white rounded-full opacity-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0">
        <div className="absolute h-2 w-2 bg-white rounded-full top-1/2 left-0 -translate-x-1/2 -translate-y-1/2"></div>
